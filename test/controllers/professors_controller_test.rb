...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { dept: @professor.dept, f_name: @professor.f_name, l_name: @professor.l_name } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { dept: @professor.dept, f_name: @professor.f_name, l_name: @professor.l_name } }
